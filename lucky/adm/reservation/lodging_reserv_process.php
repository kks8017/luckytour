...
if($case=="insert"){
    ...
    $reserv_tel_reconfirm_state = $_REQUEST['reserv_lodging_reconfirm_state_'.$i];
    ...
    $reserv_tel_deposit_state = $_REQUEST['reserv_tel_deposit_state_'.$i];
    ...
    $reserv_tel_balance_state = $_REQUEST['reserv_tel_balance_state_'.$i];
    $reserv_tel_block = $_REQUEST['tel_block'][$i];
    $reserv_tel_wait = $_REQUEST['tel_wait'][$i];
    $reserv_tel_bigo = $_REQUEST['reserv_tel_bigo'];
    $sql_price = "select * from  reservation_lodging  where no='{$no}' and reserv_del_mark!='Y'";
    $rs_price = $db->sql_query($sql_price);
    $row_price = $db->fetch_array($rs_price);
    $old_total_price = $row_price['reserv_tel_total_price'];
    ...
    $sql = "update reservation_lodging set  reserv_lodging_reconfirm_date = '{$reserv_tel_reconfirm_date}',
                                          ...
                                          reserv_tel_balance_state = '{$reserv_tel_balance_state}',
                                            reserv_tel_block = '{$reserv_tel_block}',                          
                                          reserv_tel_wait = '{$reserv_tel_wait}'
                                  
                                       
                where no='{$reserv_tel_no}'";
    echo $sql;
    $db->sql_query($sql);
    $sql_bigo = "update reservation_user_content set reserv_tel_bigo='{$reserv_tel_bigo}' where no='{$reserv_user_no}' ";
