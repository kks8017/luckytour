...
$res->res_no = $no;
$car = $res->sms_rent($reserv_rent_no);
$car_fuel = $rent->rent_code_name($car['reserv_rent_car_fuel']);
...
<table width="574" border="0" align="center">
    ...
    <tr>
        <td colspan="2"><div align="center" class="style1">렌트카신청서</div></td>
    </tr>
    <tr>
        <td colspan="2">&nbsp;</td>
    </tr>
...
<table width="574" border="1" cellpadding="0" cellspacing="0" align="center">
    ...
    <tr>
        ...
        <td>&nbsp;<?=$car['reserv_rent_car_name']?>(<?=$car_fuel?>)</td>
    </tr>
    <tr>
        <td height="46"><div align="center">사용시간</div></td>
        <td>&nbsp;<?=substr($car['reserv_rent_start_date'],0,16)?> ~ <?=substr($car['reserv_rent_end_date'],0,16)?></td>
    </tr>
    <tr>
        <td height="108"><div align="center">비고</div></td>
        <td><textarea name="text" cols="52" rows="6" style="border:0;OVERFLOW-Y: hidden;"><?=$row['reserv_rent_bigo']?></textarea></td>
    </tr>
</table>
