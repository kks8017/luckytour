...
if($case=="insert"){
    ...
    $reserv_golf_reconfirm_state = $_REQUEST['reserv_golf_reconfirm_state_'.$i];
    ...
    $reserv_golf_deposit_state = $_REQUEST['reserv_golf_deposit_state_'.$i];
    ...
    $reserv_golf_balance_state = $_REQUEST['reserv_golf_balance_state_'.$i];
    $reserv_golf_bigo = $_REQUEST['reserv_golf_bigo'];
    ...
    echo $sql;
    $db->sql_query($sql);
    $sql_bigo = "update reservation_user_content set reserv_golf_bigo='{$reserv_golf_bigo}' where no='{$reserv_user_no}' ";
