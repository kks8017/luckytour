...
$normal_price = $row_air['reserv_air_adult_normal_price'] - 8000;
?>
<table style="width: 100%">
    <tr>
        <th >출발일자</th>
        <td ><input type="text" name="start_date" id="start_date" size="15" value="<?=$start_date1[0]?>">
        ...
        <th >리턴일자</th>
        <td ><input type="text" name="end_date" id="end_date" size="15" value="<?=$end_date1[0]?>">
    ...
    <tr>
        <th >총 금액</th>
        <td ><input type="text" name="reserv_total_price" id="reserv_total_price" size="10" value="<?=$row_air['reserv_air_total_price']?>">원
        </td>
        <th >총입금액</th>
        <td ><input type="text" name="reserv_total_deposit_price" id="reserv_total_deposit_price" size="10" value="<?=$row_air['reserv_air_total_deposit_price']?>">원
        </td>
    </tr>
    <tr>
        <th >정상금액</th>
        <td  colspan="3">성인<input type="text" name="reserv_normal_adult_price" id="reserv_normal_adult_price" size="10" value="<?=$normal_price?>"> 소아 <input type="text" name="reserv_normal_child_price" id="reserv_normal_child_price" size="10" value="<?=$row_air['reserv_air_child_normal_price']?>"> </td>
    </tr>
