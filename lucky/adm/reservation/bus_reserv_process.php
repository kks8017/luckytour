...
if($case=="insert"){
    ...
    $sql = "update reservation_bus set       reserv_bus_name='{$reserv_bus_name}',
                                               ...
                                               reserv_bus_type='{$reserv_bus_type}',
    ...
    $reserv_bus_reconfirm_name = $_REQUEST['reserv_bus_reconfirm_person'][$i];
    $reserv_bus_reconfirm_state = $_REQUEST['reserv_bus_reconfirm_state_'.$i];
    ...
    $reserv_bus_deposit_state = $_REQUEST['reserv_bus_deposit_state_'.$i];
    ...
    $reserv_bus_balance_state = $_REQUEST['reserv_bus_balance_state_'.$i];

    $sql_price = "select * from  reservation_bus where no='{$no}'";
    $rs_price = $db->sql_query($sql_price);
    $row_price =  $db->fetch_array($rs_price);
    $old_total_price = $row_price['reserv_bus_total_price'];
    $reserv_bus_bigo = $_REQUEST['reserv_bus_bigo'];
    ...
    $db->sql_query($sql);
    $sql_bigo = "update reservation_user_content set reserv_bus_bigo='{$reserv_bus_bigo}' where no='{$reserv_user_no}' ";
