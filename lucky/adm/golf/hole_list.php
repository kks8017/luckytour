                ...
                if(is_array($result_hole)) {
                    foreach ($result_hole as $data){
                        ...
                        <tr>
                            ...
                            <td class="con"><input type="text" name="lodging_room_sort[]" size="3" value="<?=$data['hole_sort_no']?>"></td>
                            <td class="con"><a href="javascript:room_up_layer('<?=$data['no']?>');" id="room_up"><?=$data['hole_name']?></a></td>
...
<div id="layer_hole">
    <div class="layer_hole">
        ...
        <p style="text-align: center;"><input type="button" id="add_btn" value="홀등록"></p>
    </div>
</div>
