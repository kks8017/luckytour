<div id="nav">
    <ul id="gnb">
        <li class="m1"><a href="?linkpage=reservation&subpage=res_list"><img src="./image/menu_icon1.png" /><span>예약관리</span></a>
            <ul>
                <li><a href="?linkpage=reservation&subpage=res_list">예약현황</a></li>
                <li><a href="javascript:adm_ledger();">장부만들기</a></li>
            </ul>

        </li>
        <li class="m2"><a href="?linkpage=report&subpage=all"><img src="./image/menu_icon2.png" /><span>예약상품현황</span></a>
            <ul>
                <li><a  href="?linkpage=report&subpage=all">전체상품현황</a></li>
        ...
        <li class="m3"><a href="?linkpage=report_sell&subpage=sell"><img src="./image/menu_icon3.png" /><span>판매현황</span></a>
            <ul>
                <li><a  href="?linkpage=report_sell&subpage=sell">전체판매현황</a></li>
                ...
                <li><a  href="?linkpage=report_sell&subpage=bus">버스</a></li>
                <li><a  href="?linkpage=report_sell&subpage=bustour">버스투어</a></li>
                <li><a  href="?linkpage=report_sell&subpage=golf">골프</a></li>
            </ul>
        </li>
        <li class="m4"><a href="?linkpage=report_remit"><img src="./image/menu_icon4.png" /><span>정산관리</span></a>
            <ul>
                <li><a  href="?linkpage=report_remit">송금현황</a></li>
                <li><a  href="?linkpage=report_collect">수금현황</a></li>
                <li><a  href="?linkpage=report_card">카드현황</a></li>
                <li><a  href="?linkpage=report_tax&subpage=tax">세금계산서현황</a></li>
                <li><a  href="?linkpage=report_refund&subpage=refund">환불현황</a></li>
            </ul>
        </li>
        <li class="m5"><a href="#none"><img src="./image/menu_icon5.png" /><span>상품관리</span></a>
            <ul>
                <li><a  href="?linkpage=air">항공</a></li>
                <li><a  href="?linkpage=rent">렌트카</a></li>
                <li><a  href="?linkpage=tel">숙소</a></li>
                <li><a  href="?linkpage=bus">버스/택시</a></li>
                <li><a  href="?linkpage=bustour">버스투어</a></li>
                <li><a  href="?linkpage=golf">골프</a></li>
                <li><a  href="#">관광지</a></li>
                <li><a  href="#">식당</a></li>
                <li><a  href="?linkpage=equip">편의장비</a></li>
                <li><a  href="?linkpage=best">베스트상품</a></li>
            </ul>
        </li>
        <li class="m6"><a href="?linkpage=board"><img src="./image/menu_icon6.png" /><span>게시판관리</span></a>
            <ul>
                <li><a class="sub" href="?linkpage=board">게시판관리</a></li>
                <li><a class="sub" href="?linkpage=cash">현금영수증</a></li>
                <?php
                $sql_list = "select * from board_list";
                $rs_list  = $db->sql_query($sql_list);
                while ($row_list = $db->fetch_array($rs_list)){
                    ?>
                    <li><a  href="?linkpage=board_list&bd_no=<?=$row_list['no']?>&board_table=<?=$row_list['bd_id']?>"><?=$row_list['bd_name']?></a></li>
                    <?php
                }
                ?>
            </ul>
        </li>
        <li class="m7"><a href="?linkpage=company"><img src="./image/menu_icon7.png" /><span>사이트관리</span></a>
            <ul>
                <li><a  href="?linkpage=person_list">관리자관리</a></li>
                <li><a  href="?linkpage=company">사이트관리</a></li>
            </ul>
        </li>
    </ul>
...
<script>
    function adm_ledger() {
        if(confirm("장부를 생성하시겠습니다?") == false) {
            return false;
        }else{
            window.open("reservation/reservation_ledger.php?ledger=adm", "ledger_pop", "width=1450,height=900");
        }
    }
</script>