...
if(!$_REQUEST['start_date']){$start_date_a = date("Y-m",time()); $start_date = $start_date_a."-01";}else{$start_date_a = $_REQUEST['start_date'];$start_date = $start_date_a;}
if(!$_REQUEST['end_date']){$end_date_a = date("Y-m",time()); $end_date = $end_date_a."-31";}else{$end_date_a = $_REQUEST['end_date'];$end_date = $start_date_a;}
...
<div class="reservation_report">
    <div>
        ...
        <table class="tbl_total">
            <tr>
                <td>예약금수금액 : <?=set_comma($total_deposit_price)?>원</td>
            </tr>
        </table>
        <br>
        <br>
        <table class="tbl">
            ...
            if(is_array($reservation_payment)) {
                foreach ($reservation_payment as $reservation) {
                    ...
                    <?php
                    $total_payment_price += $reservation['reserv_etc_price'];
                    $i++;
                }
            }else{
                ?>
        ...
        <table class="tbl_total">
            <tr>
                <td >중도금수금액 : <?=set_comma($total_payment_price)?>원</td>
            </tr>
        </table>
        <br>
        <br>
        ...
        <table class="tbl_total">
            <tr>
                <td >잔금수금액 : <?=set_comma($total_balance_price)?>원</td>
            </tr>
        </table>
        <br>
        <br>
        ...
        <table class="tbl_total">
            <tr>
                <td >카드수금액 : <?=set_comma($total_card_price)?>원</td>
            </tr>
        </table>
