...
$sql = "select no,rent_com_no,rent_car_name,rent_car_type,rent_car_fuel,rent_car_year_type,rent_car_option,rent_car_image,rent_car_insurance,rent_car_open,rent_car_sort,rent_car_seater from rent_car_detail where no='{$no}'";
$rs  = $db->sql_query($sql);
...
?>
    ...
    <table class="tbl_car">
        ...
        <tr>
            <th>차량인승</th>
            <td><input type="text" name="rent_car_seater" size="2" value="<?=$row['rent_car_seater']?>"> 인승 </td>
        </tr>
        <tr>
            <th>차량년식</th>
