...
<div class="rent_company" >
    <p class="del_btn"><img src="./image/sel_mod.gif"  id="mod_btn" style="cursor: pointer;" /> <img src="./image/sel_del.gif"  id="del_btn" style="cursor: pointer;" />  <input type="button" id="com_btn" value="코드등록"></p>
      <form id="com_frm">
        <table class="tbl">
            <tr>
