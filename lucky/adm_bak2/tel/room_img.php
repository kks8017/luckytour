...
<table>
    <tr>
        <td>객실명</td>
        <td><input type="text" name="lodging_room_name" id="lodging_room_name_up" value="<?=$row_room['lodging_room_name']?>"></td>
    </tr>
    <tr>
        <td>기준인원</td>
        <td><input type="text" name="lodging_room_min" id="lodging_room_min_up" size="3" value="<?=$row_room['lodging_room_min']?>">/<input type="text" name="lodging_room_max" id="lodging_room_max_up" size="3" value="<?=$row_room['lodging_room_max']?>"></td>
    </tr>
    <tr>
        <td>객실구조</td>
        <td><input type="text" name="lodging_room_structure" id="lodging_room_structure_up" value="<?=$row_room['lodging_room_structure']?>"></td>
    </tr>
    <tr>
        <td>객실구비사항</td>
        <td><input type="text" name="lodging_room_satisfy" id="lodging_room_satisfy_up" value="<?=$row_room['lodging_room_satisfy']?>"></td>
    </tr>
    <tr>
        <td>객실뷰</td>
        <td><input type="text" name="lodging_room_view" id="lodging_room_view_up" value="<?=$row_room['lodging_room_view']?>"></td>
    </tr>
    <tr>
        <td>이미지</td>
        <td>
