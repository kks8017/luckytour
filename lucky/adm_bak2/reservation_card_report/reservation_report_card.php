    ...
    <div>
        ...
        <table>
            <tr>
                ...
                <td class="title">카드결제</td>
                <td class="title">항공</td>
                <td class="title">렌트</td>
                <td class="title">숙박</td>
                <td class="title">버스</td>
                <td class="title">버스투어</td>
                <td class="title">골프</td>
            ...
            if(is_array($reservation_card)) {
                foreach ($reservation_card as $card) {
                    ...
                    <tr>
                        ...
                        <td class="content"><input type="button" value="예약대장" onclick="ledger('<?= $card['no'] ?>')"></td>
                    </tr>
                    <?php
