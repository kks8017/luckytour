...
<div class="reserv_rent_add">
    <div>
        ...
        <form id="bustour_sch_frm">
            <table>
                <tr>
                    <td class="title">투어명</td>
                    <td class="cont" colspan="3"><input type="text" name="reserv_bustour_name" value="<?=$row_bustour['reserv_bustour_name']?>"> </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="cont" ><input type="text" name="reserv_bustour_total_price" value="<?=set_comma($row_bustour['reserv_bustour_total_price'])?>" size="10"></td>
                    <td class="title">입금가</td>
                    <td class="cont" ><input type="text" name="reserv_bustour_deposit_price" value="<?=set_comma($row_bustour['reserv_bustour_total_deposit_price'])?>" size="10"></td>
                </tr>
            </table>
        ...
        <table>
                <tr>
                <td align="center"><input type="button" id="bustour_sch_btn" value="검색"> <input type="button" id="bustour_update_btn" value="변경"> <input type="button" id="bustour_delete_btn" value="삭제"></td>
            </tr>
        </table>
    </div>
    <div id="bustour_list">
