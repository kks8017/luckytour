...
<div class="reserv_equip_add">
    <div>
        ...
        <form id="bustour_sch_frm">
            <table>
                ...
                <tr>
                    ...
                    <td class="cont" ><input type="text" name="reserv_equip_total_price" value="<?=set_comma($row_eq['reserv_equip_total_price'])?>" size="10"></td>
                    <td class="title">입금가</td>
                    <td class="cont" ><input type="text" name="reserv_equip_total_deposit_price" value="<?=set_comma($row_eq['reserv_equip_total_deposit_price'])?>" size="10"></td>
                </tr>
            </table>
        ...
        <table>
            <tr>
                <td align="center"><input type="button" id="update_btn" value="변경"> <input type="button" id="delete_btn" value="삭제"></td>
            </tr>
        </table>
    </div>
