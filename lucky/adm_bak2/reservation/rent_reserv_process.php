...
if($case=="insert"){
  ...
  //  echo $sale_car_price_deposit;
    ...
    $sql = "update  reservation_rent set reserv_rent_com_no= '{$rent_com_no}',
                                           ...
                                           reserv_rent_car_fuel = '{$rent_fuel}',
                                           reserv_rent_car_type = '{$rent_type}',
                                           reserv_rent_start_date = '{$start_date}',
                                           reserv_rent_end_date ='{$end_date}',
    ...
    $reserv_rent_reconfirm_state = $_REQUEST['reserv_rent_reconfirm_state'][$i];
    ...
    $reserv_rent_deposit_state = $_REQUEST['reserv_rent_deposit_state'][$i];
    ...
    $reserv_rent_balance_state = $_REQUEST['reserv_rent_balance_state'][$i];
