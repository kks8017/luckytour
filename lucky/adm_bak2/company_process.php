...
if($case=="insert"){
    ...
    $tour_cancel     = addslashes($_REQUEST["tour_cancel"]);
    $tour_address    = addslashes($_REQUEST["tour_address"]);
    $tour_privacy    = addslashes($_REQUEST["tour_privacy"]);
    ...
    if($tour_main=="Y") {
        if ($num_main > 0) {
            ...
            $sql = "update tour_company set tour_name='{$tour_name}',tour_title='{$tour_title}',tour_domain='{$tour_domain}',tour_ceo='{$tour_ceo}',tour_com_number='{$tour_com_number}',tour_fax='{$tour_fax}',tour_insurance='{$tour_insurance}',tour_tourism='{$tour_tourism}'
