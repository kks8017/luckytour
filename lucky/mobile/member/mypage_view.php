...
?>
<p class="res-title-end">내가 선택한 상품내역</p>
    ...
    <table>
        <tr>
            ...
            <td class="res-price-list-text" colspan="2" style=" border-right: 1px solid #A4A4A4;">
                <span class="res-price-list-item"><?=$pack_text?></span>
            </td>
        </tr>
        <tr>
            <td class="res-price-list-title">여행인원</td>
            <td class="res-price-list-text" colspan="2" style=" border-right: 1px solid #A4A4A4;">
                성인 <span class="res-price-list-item-num"><?=$res_view['reserv_adult_number']?>명</span>, 소아 <span class="res-price-list-item-num"><?=$res_view['reserv_child_number']?>명</span>, 유아 <span class="res-price-list-item-num"><?=$res_view['reserv_baby_number']?>명</span>
            </td>
        </tr>
        <?php
        ...
        <tr>
            ...
            <td class="res-price-list-text" colspan="2" style=" border-right: 1px solid #A4A4A4;">
                <span class="res-price-list-item">[<?= $rent['reserv_rent_car_name'] ?>](<?=$fuel?>)</span> <?= $rent['reserv_rent_vehicle'] ?>대
                <span class="res-price-list-item-num"><?= $rent['reserv_rent_time'] ?>시간</span> <?= $rent_s_date[0] ?> <?= substr($rent_s_date[1], 0, 5) ?>
        ...
        <tr>
            <td class="res-price-list-text-info" colspan="3" style=" border-right: 1px solid #A4A4A4;">
                * 예약이 접수되면 확인전화를 드리기 전까지는 예약확정이아니라
                예약접수 상태입니다.
            </td>
        </tr>
    </table>
...
<div class="res-item-list-end">
    <table>
        ...
        <tr>
            <td class="res-price-list-title-blue">소아 탑승자명단<br>
                <span style="font-size:25px;">(만24개월 미만)</span>
            </td>
            <td class="res-price-list-text-blue" style=" border-right: 1px solid #A4A4A4;">
        ...
        <tr>
            ...
            <td class="res-price-list-text-blue" style=" border-right: 1px solid #A4A4A4;">
                <?=$row['reserv_rent_departure_place']?>
            </td>
        </tr>
        <tr>
