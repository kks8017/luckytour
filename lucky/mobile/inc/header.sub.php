        ...
        <ul>
            <li class="header-top-title" style="width: 10%;">
                <button id="pop-menu_bt">
                    <img src="<?=KS_SUB_DIR?>images/menu.png" height="40">
                </button>
            </li>
            <li class="header-top-title" style="width: 80%;">
                <a href="<?=KS_SUB_DIR?>index.php">
                    <img src="<?=KS_SUB_DIR?>images/logo.png"  width="200">
                </a>
            </li>
            <li class="header-top-title"  style="width: 10%;">
                <?php
                if($_SESSION['user_id']){
                    ?>
                <a href="<?=KS_SUB_DIR?>member/mypage.php">
                    <img src="<?=KS_SUB_DIR?>images/mypage.png" height="40">
                </a>
            </li>
                <?}else{?>
                    <a href="<?=KS_SUB_DIR?>member/login.php">
                        <img src="<?=KS_SUB_DIR?>images/mypage.png" height="40">
                    </a>
                    </li>
                <?}?>
    ...
    <div  class="header-menu">
        <ul>
            <li class="header-menu-title" style="padding-left: 5px;">
                <a href="<?=KS_SUB_DIR?>package/package_list.php?package_type=ACT">자유여행패키지</a></li>
            <li class="header-menu-title">
                <a href="<?=KS_SUB_DIR?>air/air.php">항공</a></li>
            <li class="header-menu-title">
                <a href="<?=KS_SUB_DIR?>tel/tel_list.php">숙박</a></li>
            <li class="header-menu-title">
                <a href="<?=KS_SUB_DIR?>car/car_list.php">렌터카</a>
            </li>
            <li class="header-menu-title">
                <a href="<?=KS_SUB_DIR?>bus/bus_list.php">버스/택시</a>
            </li>
        </ul>
    </div>
</div>
            ...
            <table>
                <tr>
                    <td style="border-bottom: 2px solid #BDBDBD; border-right: 2px solid #BDBDBD;">
                        <a href="<?=KS_SUB_DIR?>res/res_end.php">
                            <span class="res"></span>
                            <span class="menu-title">예약확인</span>
                        </a>
                    </td>
                    <td style="border-bottom: 2px solid #BDBDBD; ">
                        <a href="<?=KS_SUB_DIR?>customer/notice.php">
                            <span class="con"></span>
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?=KS_SUB_DIR?>member/member_join.php">
        ...
        <div class="pop-sub-menu">
            <table class="sub-menu">
                <tr>
                    ...
                    <td class="icon-text">
                        <a href="<?=KS_SUB_DIR?>package/package_list.php">자유여행패키지</a>
                    </td>
                    <td class="icon-back">
                ...
                <tr>
                    ...
                    <td class="icon-text">
                        <a href="<?=KS_SUB_DIR?>air/air_list.php">항공</a>
                    </td>
                    <td class="icon-back">
                        <span class="icon_select"></span>
                    </td>
                ...
                <tr>
                    ...
                    <td class="icon-text">
                        <a href="<?=KS_SUB_DIR?>tel/tel_list.php">숙박</a>
                    </td>
                    <td class="icon-back">
                        <span class="icon_select"></span>
                    </td>
