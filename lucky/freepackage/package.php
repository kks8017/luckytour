...
?>
    ...
    <script>
        ...
        function air_selected(i) {
            ...
            var air_html="";
            air_html += "<p  class=\"data\"><img src='"+$("#air_img_"+i).val()+"' class='air_mark' style='width:18px;height: 18px;'/><span class='txt'>"+$("#air_area_"+i).val()+"</span><span class='txt'>출발</span><span class='date'>"+$("#air_departure_date_"+i).val()+" ("+$("#air_start_week_"+i).val()+")</span> ";
            air_html += "<span class=\"blue\">"+s_day+" "+$("#air_start_hour_"+i).val()+":"+$("#air_start_minute_"+i).val()+"</span><span class='arrow'>↔</span>";
            air_html += "<img src='"+$("#air_img_"+i).val()+"' class='air_mark' style='width:18px;height: 18px;'/><span class='txt'>제주</span><span class='txt'>출발</span><span class='date'>"+$("#air_arrival_date_"+i).val()+" ("+$("#air_end_week_"+i).val()+")</span>";
