...
?>
    ...
    <div id="content">
        ...
        <div class="faq">
            ...
            <div class="lmenu">
                <ul>
                    <li><a href="./tour_counseling.html">여행상담문의<img src="../sub_img/off_left_arrow.png" /></a></li>
                    <li><a href="./after_list.html">여행후기<img src="../sub_img/off_left_arrow.png" /></a></li>
                ...
                <div class="res-info">
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="res-info-text">
                                성인 <span class="res-info-text-num"> <?=$res_view['reserv_adult_number']?>명</span>, 소아 <span class="res-info-text-num"> <?=$res_view['reserv_child_number']?>명</span>, 유아 <span class="res-info-text-num"> <?=$res_view['reserv_baby_number']?>명</span> (항공, 숙박, 차량 요금에 적용되는 인원 기준입니다.)
                            </td>
                        </tr>
                        <?php
                    ...
                    <div class="res-button">
                        <button type="button" onclick="window.history.back(-1);">목록으로</button>
                    </div>
                </div>
