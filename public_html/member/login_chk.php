...
if($user_row['user_id']) {
    ...
    if($user_password==$pass_row['user_passwd']) {
        ...
        echo "<input type='hidden' name='id_chk' id='id_chk' value='YES'>";
       // goto_url("/index.html");
    }else{
        echo "<input type='hidden' name='id_chk' id='id_chk' value='NO'>";
    }
}else {
    echo "<input type='hidden' name='id_chk' id='id_chk' value='ID'>";
