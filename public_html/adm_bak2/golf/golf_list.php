...
<div class="golf_list">
    <div>
        <table>
            <tr>
                <td colspan="8"><input type="button" id="mod_btn" value="선택수정"><input type="button" id="del_btn" value="선택삭제"><input type="button" id="golf_add_btn" value="골프장등록"> </td>
            </tr>
            <tr>
                <td class="sele"><input type="checkbox" id="allsel"></td>
                <td class="sort">순서</td>
                <td class="name">골프장명</td>
                    ...
                    foreach ($result_list as $data){
                       ...
                       ?>
                        <tr>
                            ...
                            <td class="cont"><input type="text" name="golf_sort_no[]" value="<?=$data['golf_sort_no']?>" size="3"></td>
                            <td class="cont"><a href="?linkpage=<?=$_REQUEST['linkpage']?>&subpage=detail&no=<?=$data['no']?>"><?=$data['golf_name']?></a></td>
                            <td class="cont"><?=$area?></td>

                            <td class="cont"><input type="checkbox" name="golf_open_chk[]" value="Y" <?if($data['golf_open_chk']=="Y"){?>checked<?}?>></td>
