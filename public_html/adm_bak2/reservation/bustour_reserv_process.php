...
if($case=="insert"){
    ...
    $reserv_bustour_date = $_REQUEST['start_year']."-".$_REQUEST['start_month']."-".$_REQUEST['start_day'];
    ...
    $reserv_bustour_deposit_state = $_REQUEST['reserv_bustour_deposit_state'][$i];
    ...
    $reserv_bustour_balance_state = $_REQUEST['reserv_bustour_balance_state'][$i];
